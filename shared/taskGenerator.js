...
import small from './presets/task-presets/small.json' with { type: "json" };
import constantPeriod from './presets/task-presets/constant-period.json' with { type: "json" };
import medium from './presets/task-presets/medium.json' with { type: "json" };
import largeSparse from './presets/task-presets/large-sparse.json' with { type: "json" };
import largeDense from './presets/task-presets/large-dense.json' with { type: "json" };
import pipeline from './presets/task-presets/pipeline.json' with { type: "json" };
import highUtilization from './presets/task-presets/high-utilization.json' with { type: "json" };
